	...
	public LDAPUser login(String aUserName, String aPassword) throws InvalidLoginException {
		...
		try {
			...
			if ( message instanceof LDAPSearchResult  ) {
				...
				disconnect();
				FacesMessage messageUsernotfound = new FacesMessage(FacesMessage.SEVERITY_ERROR, "Username or password is incorrect","");  	          
			...
			e.printStackTrace();
			FacesMessage messagePasswordIncorrect = new FacesMessage(FacesMessage.SEVERITY_ERROR, "Username or password is incorrect","");  	          
	        FacesContext.getCurrentInstance().addMessage(null, messagePasswordIncorrect);
